...
[ppw2004/kuiba-worldview](https://github.com/ppw2004/kuiba-worldview)：用本框架对一部两卷中文小说的设定文本构建的首个完整知识库——566 块语料 → 1624 实体 / 3555 关系，562 校验单元 99.8% 完成、金查询回归 10/10；公开了数据集（含 20202 条校验 trace）、13:50 四幕图谱渲染短片与在线问答站点。
